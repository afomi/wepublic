...
config :wepublic, WepublicWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: WepublicWeb.ErrorHTML, json: WepublicWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Wepublic.PubSub,
  live_view: [signing_salt: "oK8CZgfi"]
...
config :wepublic, Wepublic.Mailer, adapter: Swoosh.Adapters.Local
