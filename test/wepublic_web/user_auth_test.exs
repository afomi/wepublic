defmodule WepublicWeb.UserAuthTest do
  use WepublicWeb.ConnCase, async: true

  alias Wepublic.Accounts
  alias Wepublic.Accounts.Scope
  alias WepublicWeb.UserAuth

  import Wepublic.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, WepublicWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
